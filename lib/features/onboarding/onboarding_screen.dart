...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _onNext() {
    if (_index < _steps.length - 1) {
      ...
      // Конец онбординга → на гостевой стартовый экран. Вход потребуется
      // только при создании заказа или открытии живого каталога.
          ...
          Positioned(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (_, i) => Image.asset(
                ...
                // значимая часть нарисована сверху, и при центрировании
                // её срезал статус-бар. Обрезаем только снизу — там
                // уходит под скругление шторки.
