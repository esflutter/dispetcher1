...
/// Полный сброс локального состояния. Публичный: его зовёт и ручной выход
/// (ниже), и обработчик ПРИНУДИТЕЛЬНОГО разлогина в main — раньше тот чистил
/// только чат ассистента, и заказы/профиль юзера А оставались видны юзеру Б.
void clearAllLocalState() => _clearAll();
